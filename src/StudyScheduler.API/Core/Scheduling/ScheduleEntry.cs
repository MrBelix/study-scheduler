...
/// <summary>
/// One entry of a tutor's merged schedule — either a physical <see cref="Lesson"/> row or a
/// virtual series occurrence expanded in memory (<see cref="IsVirtual"/> true, <see cref="Id"/>
/// null). The cross-slice read shape: the Lessons slice maps it to its HTTP contract, later slices
/// (notifications) plan from it — neither depends on the other's types.
/// </summary>
