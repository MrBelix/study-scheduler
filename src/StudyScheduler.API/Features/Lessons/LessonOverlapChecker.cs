    ...
    ILogger<LessonOverlapChecker> logger)
{
        ...
        CancellationToken ct = default)
    {
        ...
        // Unmaterialized occurrences of active series. A materialized occurrence is governed by
        // its concrete lesson (already checked above; if it was cancelled or rescheduled away,
        // the slot is free) — SeriesExpansion suppresses those.
