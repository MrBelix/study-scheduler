...
/// <summary>EF Core implementation of <see cref="ILessonRepository"/> (PostgreSQL).</summary>
public sealed class EfLessonRepository(AppDbContext db) : ILessonRepository
{
    ...
    public async Task<IReadOnlyList<Lesson>> GetByTutorInRangeAsync(
        long tutorTelegramId,
        ...
        CancellationToken ct = default)
    {
        ...
        return await query.SingleOrDefaultAsync(
            l => l.SeriesId == seriesId && l.OccurrenceDate == occurrenceDate && l.TutorTelegramId == tutorTelegramId, ct);
    }

    public async Task<IReadOnlyList<Lesson>> GetMaterializedForSeriesFromAsync(
        Guid seriesId,
        long tutorTelegramId,
        ...
        CancellationToken ct = default)
    {
        ...
        return await query
            .Where(l => l.SeriesId == seriesId
                && l.TutorTelegramId == tutorTelegramId
                && l.OccurrenceDate >= fromOccurrenceDate)
            .ToListAsync(ct);
    }
