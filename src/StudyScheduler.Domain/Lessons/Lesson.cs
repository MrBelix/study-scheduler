...
public sealed class Lesson : Entity
{
    ...
    /// <summary>Moves the lesson to another start instant, keeping its duration. Any instant is valid.</summary>
    ...
    /// <summary>Changes how long the lesson runs, keeping its start.</summary>
